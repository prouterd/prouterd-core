...
require_relative "api/body_reader"
require_relative "api/webhook_handler"
require_relative "api/v1"
require_relative "api/rpc_dispatcher"
require_relative "api/events_websocket"
require_relative "api/cli_websocket"
require_relative "api/app"

module Prouterd
  module API
    # Server is loaded lazily so requiring `prouterd` doesn't pull in puma at
    # boot — only the `prouterd` daemon instantiates it.
